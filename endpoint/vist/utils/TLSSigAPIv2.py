...
class TLSSigAPIv2:
    __sdkappid = Constants.SDK_APP_ID
    __version = '2.0'
    __key = Constants.SDK_KEY
...
api = TLSSigAPIv2(Constants.SDK_APP_ID, Constants.SDK_KEY)


def genUserSig(user_id):
    return {
        'userId': user_id,
        'sdkAppId': Constants.SDK_APP_ID,
        'userSig': api.genUserSig(user_id)
    }
